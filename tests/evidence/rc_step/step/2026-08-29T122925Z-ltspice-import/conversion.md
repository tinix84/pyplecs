```
uv run pyplecs-convert tests/fixtures/rc_step.asc --format plecs --probe 'C1:Capacitor voltage' --probe 'R1:Resistor current' -o tests/evidence/rc_step/step/2026-08-29T122925Z-ltspice-import
```
